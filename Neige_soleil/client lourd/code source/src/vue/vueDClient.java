...
public class vueDClient extends JPanel implements ActionListener {
	
	private JButton btClose = new JButton("X");
	private JTextField txtID = new JTextField();
	private JButton btDelete = new JButton("Supprimer");
	private JLabel consigne = new JLabel("ID du client à supprimer : ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==this.btDelete) {
			ModeleClient.delete(ModeleClient.StringToInt(this.txtID.getText()));
			int i = Tableau.rechercher (vueClient.getUneTable(),this.txtID.getText() );
			
			Tableau.supprimerLigne(vueClient.getUneTable(), i);
		}
	}
