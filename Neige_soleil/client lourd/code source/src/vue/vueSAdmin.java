...
public class vueSAdmin extends JPanel implements ActionListener {
	...
	public vueSAdmin(){
		Object[] elements = new Object[]{"Nom","Prenom","Email"};
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==this.btModify) {
			ModeleAdmin.set(ModeleAdmin.StringToInt(this.txtID.getText()),this.txtChamp.getText(),this.liste.getSelectedItem().toString());
		}
	}
}