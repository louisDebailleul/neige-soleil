...
public class vueSListeLoc extends JPanel implements ActionListener {
	...
	public vueSListeLoc(){
		Object[] elements = new Object[]{"Nom","Chambres","Places","Ville","Adresse","CodeP","Vallee","PrixJ","PrixS","Douches"};
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==this.btModify) {
			ModeleListeLoc.set(ModeleListeLoc.StringToInt(this.txtID.getText()),this.txtChamp.getText(),this.liste.getSelectedItem().toString());
		}
	}
}
