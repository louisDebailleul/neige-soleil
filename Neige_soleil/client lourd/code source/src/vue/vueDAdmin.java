...
public class vueDAdmin extends JPanel implements ActionListener {
	
	private JButton btClose = new JButton("X");
	private JTextField txtID = new JTextField();
	private JButton btDelete = new JButton("Supprimer");
	private JLabel consigne = new JLabel("ID de l'admin à supprimer : ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==this.btDelete) {
			ModeleAdmin.delete(ModeleAdmin.StringToInt(this.txtID.getText()));
		}
	}
}