...
public class vueSLocation extends JPanel implements ActionListener {
	...
	public vueSLocation(){
		Object[] elements = new Object[]{"Confirme","Message","Acompte"};
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==this.btModify) {
			ModeleLocation.set(ModeleLocation.StringToInt(this.txtID.getText()),this.txtChamp.getText(),this.liste.getSelectedItem().toString());
		}
	}
}