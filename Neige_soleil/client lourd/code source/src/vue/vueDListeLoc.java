...
public class vueDListeLoc extends JPanel implements ActionListener {
	
	private JButton btClose = new JButton("X");
	private JTextField txtID = new JTextField();
	private JButton btDelete = new JButton("Supprimer");
	private JLabel consigne = new JLabel("ID de la location à supprimer : ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==this.btDelete) {
			ModeleListeLoc.delete(ModeleListeLoc.StringToInt(this.txtID.getText()));
		}
	}
}